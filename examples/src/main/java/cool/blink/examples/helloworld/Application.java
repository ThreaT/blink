...
public class Application extends Blink {
    ...
    public Application(Scenario fail, WebServer webServer, Database_Deprecated database, Cluster cluster, Node node, Scenario... scenarios) {
    ...
    public static void main(String args[]) {
        try {
            application = new Application(
                    ...
                    new Database_Deprecated("helloworld_database", "", Foo.class),
