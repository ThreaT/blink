...
import cool.blink.front.css.template.Base64Backgrounds;
import cool.blink.front.css.template.NoHeightReset;
...
public class Home extends Scenario {
    ...
    public static final class HomeTemplate {
        ...
        protected HomeTemplate() {
            Logger.getLogger(HomeTemplate.class.getName()).log(Priority.MEDIUM, "Preparing HomeTemplate...");
            this.html = new Html();
            this.head = new Head();
