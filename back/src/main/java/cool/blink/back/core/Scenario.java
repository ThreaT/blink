...
public class Scenario implements Cloneable {
    ...
    /**
     * Used to determine if scenario is fit to process request or not.
     *
    ...
    /**
     * Used for scenario main processing.
     *
     * @param request request
     */
    ...
    /**
     * @return method responsible for processing the request.
     */
    ...
    public String toString() {
        return "Scenario{" + "clazz=" + clazz + ", urls=" + urls + ", etag=" + etag + ", fit=" + fit + ", main=" + main + ", test=" + test + '}';
    }
