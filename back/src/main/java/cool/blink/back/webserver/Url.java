...
import cool.blink.back.utilities.HttpUtilities.Protocol;
...
public final class Url implements Serializable {
    ...
    public Url(final String url) throws MalformedURLException {
        ...
        this.protocol = HttpUtilities.getProtocolEnum(tempUrl.getProtocol());
    ...
    public static final synchronized String removeExcessForwardSlashes(final String url) throws MalformedURLException {
        Protocol protocol = HttpUtilities.findProtocol(url);
        String temp = url;
    ...
    public static final synchronized String removePort(final String url) {
        if (url.contains(":")) {
    ...
    public static final synchronized String getPathEnd(final String url) {
