package cool.blink.front.html.template;
 ...
 * etags??)
 */
public class BlackAndWhite1Col {

    public static void main(String args[]) {
        BlackAndWhite1Col blackAndWhite = new BlackAndWhite1Col();
    ...
    public BlackAndWhite1Col() {
        ...
        this.box = (Div) new Div().append(new Style(new Width(90, WidthValue.percent), new Height(20, HeightValue.percent), new Position(PositionValue.relative), new BackgroundColor(252, 252, 254, 1.0), new MarginLeft(MarginLeftValue.auto), new MarginRight(MarginRightValue.auto), new MarginBottom(10, MarginBottomValue.percent)));
