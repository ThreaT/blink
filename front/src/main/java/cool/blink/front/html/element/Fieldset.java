...
public final class Fieldset extends Element {

    public Fieldset() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Fieldset(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Fieldset(final FrontContent attributes, final FrontContent content) {
