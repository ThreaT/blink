...
public final class Article extends Element {

    public Article() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Article(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Article(final FrontContent attributes, final FrontContent content) {
