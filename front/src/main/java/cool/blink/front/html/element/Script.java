...
public final class Script extends Element {

    public Script() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Script(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Script(final FrontContent attributes, final FrontContent content) {
