...
public final class Textarea extends Element {

    public Textarea() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Textarea(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Textarea(final FrontContent attributes, final FrontContent content) {
