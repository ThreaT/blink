...
public final class Canvas extends Element {

    public Canvas() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Canvas(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Canvas(final FrontContent attributes, final FrontContent content) {
