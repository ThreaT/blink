...
public final class Center extends Element {

    public Center() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Center(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Center(final FrontContent attributes, final FrontContent content) {
