...
public final class Acronym extends Element {

    public Acronym() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Acronym(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Acronym(final FrontContent attributes, final FrontContent content) {
