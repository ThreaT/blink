...
public final class Details extends Element {

    public Details() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Details(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Details(final FrontContent attributes, final FrontContent content) {
