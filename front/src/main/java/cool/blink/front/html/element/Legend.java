...
public final class Legend extends Element {

    public Legend() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Legend(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Legend(final FrontContent attributes, final FrontContent content) {
