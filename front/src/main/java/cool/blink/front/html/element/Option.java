...
public final class Option extends Element {

    public Option() {
        super(TagType.fertile, new FrontContent(""), new FrontContent(""));
    }

    public Option(final FrontContent content) {
        super(TagType.fertile, new FrontContent(""), content);
    }

    public Option(final FrontContent attributes, final FrontContent content) {
