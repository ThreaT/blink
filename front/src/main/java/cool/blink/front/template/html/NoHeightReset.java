...
public final class NoHeightReset {

    private final String reset;

    public NoHeightReset() {
        ...
        String mainProperties = new Margin(0, MarginValue.blank).print() + new Padding(0, PaddingValue.blank).print() + new Border(0, BorderWidthValue.blank).print() + new FontSize(100, FontSizeValue.percent).print() + new Font(FontValue.inherit).print() + new VerticalAlign(VerticalAlignValue.baseline).print();
        //+ new Height(100, HeightValue.percent).print();
